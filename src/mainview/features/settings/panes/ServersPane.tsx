...
export function ServersPane() {
	...
	return (
		<Pane
			...
			title="Servers"
			description="Navidrome, OpenSubsonic, and Subsonic endpoints. Switch between them or run a speed test to see how each connection performs."
		>
					...
					fallback={
						<div class={styles.emptyState}>
							...
							<p class={styles.emptyHint}>
								Connect your first Navidrome, OpenSubsonic, or Subsonic server to start
								listening.
							</p>
